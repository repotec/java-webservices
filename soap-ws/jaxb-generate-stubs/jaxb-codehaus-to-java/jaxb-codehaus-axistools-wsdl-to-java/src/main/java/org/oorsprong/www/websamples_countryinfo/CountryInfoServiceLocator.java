 ...
 */
    ...
    public org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapType getCountryInfoServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapBinding12Stub _stub = new org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapBinding12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapBinding12Stub _stub = new org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapBinding12Stub(new java.net.URL(CountryInfoServiceSoap12_address), this);
                _stub.setPortName(getCountryInfoServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (org.oorsprong.www.websamples_countryinfo.CountryInfoServiceSoapType.class.isAssignableFrom(serviceEndpointInterface)) {
