...
public class TCountryInfo  implements java.io.Serializable {
    ...
    private org.oorsprong.www.websamples_countryinfo.ArrayOftLanguage languages;
    ...
    public TCountryInfo(
           ...
           org.oorsprong.www.websamples_countryinfo.ArrayOftLanguage languages) {
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.oorsprong.org/websamples.countryinfo", "ArrayOftLanguage"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
